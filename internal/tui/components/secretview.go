...
func svPathStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Primary).Bold(true)
}

func svLabelStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Subtle)
}

func svMetaValStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Text)
}

func svDividerStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Overlay)
}

func svKeyStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Yellow)
}

func svValueStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Text)
}

func svSectionStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Blue).Bold(true)
}

func svEmptyStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Subtle).Italic(true)
}

func svVersionActiveStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Green)
}

func svVersionDeletedStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Subtle)
}

func svVersionDestroyedStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Red)
}

func svVersionNumStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Primary).Bold(true)
}

func svTimestampStyle() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(theme.Active.Subtle)
}
